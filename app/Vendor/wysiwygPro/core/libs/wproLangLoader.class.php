	...
	*/
	function load (&$EDITOR) {
		...
		if (is_file($this->langFolderDir.$this->preferredLang.'/'.$this->filename)) {
			...
			include($this->langFolderDir.$this->preferredLang.'/'.$this->filename);//leon this causes issue
//			include("/home/klepfish/public_html/memberdeskdev/members/wysiwygPro/lang/en-us/wysiwygpro/lang.inc.php");

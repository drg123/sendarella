...
<?php echo $this->Form->create('Email');?>
	<fieldset>
		<legend><?php echo __('New Broadcast Email'); ?></legend>
	<?php
...
$editor->imageDir = "/home/drgranat/public_html/app/webroot/img/public/$id/"; 
$editor->imageURL = "http://www.sendarella.com/img/public/$id/"; 

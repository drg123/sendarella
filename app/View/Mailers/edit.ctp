...
<?php echo $this->Form->create('Mailer', array('type' => 'file'));?>
	<fieldset>
		<legend><?php echo __('Edit Mailer'); ?></legend>
...
$editor->value = $mailer['Mailer']['content'];
...
$editor->imageDir = "/home/drgranat/public_html/app/webroot/img/public/".$mailer['Mailer']['content']."/"; 
$editor->imageURL = "http://www.sendarella.com/img/public/".$mailer['Mailer']['content']."/"; 
...
$('#MailerEditForm').submit(function(e) {
